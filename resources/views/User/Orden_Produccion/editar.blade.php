                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Editar Orden</h5>
                                        <button class="btn btn-danger float-right" id="btnactualizar">Actualizar
                                        </button>
                                        <button class="btn btn-outline-primary btn-sm float-right"><a href="{{Request::root(('requisas/create'))}}" class="" id="btnrequisa">Solicitar Requisa</a>
                                        </button>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="numOrden">Orden de Producción
                                                            No.</label>
                                                        <input type="text" class="form-control" name="numOrden" id="numOrden" value="{{ $ord->numOrden }}">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <small id="hrsTrabajadasHelp" class="form-text text-muted">Especifique las
                                                            hras
                                                            trabajadas</small>
                                                    </div>
                                                </div>
