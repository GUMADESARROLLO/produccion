...
<body>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <table class="table" style="margin-left: 38.9rem; width:450px !important; margin-top: -6.1rem">
                <tr class="">
    ...
    <div class="row">
        <div class="col-12">
            <table class="table-format cell-border table-sm " style="margin-bottom: 0rem; margin-top: -0.2rem;">
                <thead class="">
