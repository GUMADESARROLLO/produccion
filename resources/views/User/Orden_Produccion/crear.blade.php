                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h5>Generales</h5>
                                            <hr>
                                            <form method="post" action="{{url('orden-produccion/guardar')}}"
                                                  id="formdataord">
                                                {{ csrf_field() }}
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly class="form-control"
                                                                   name="numOrden" id="numOrden"
                                                                   value="{{ $idOrd['numOrden']+1 }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="producto" id="producto">
                                                                @foreach($productos as $p)
                                                                    <option
                                                                        value="{{ $p['idProducto'] }}">{{ $p['nombre'] }}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="jefe" id="jefe">
                                                                @foreach($usuarios as $u)
                                                                    <option
                                                                        value="{{ $u['id'] }}">{{ $u['nombres'] }} {{ $u['apellidos'] }}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="hrsTrabajadas"
                                                                   id="hrsTrabajadas"
                                                                   value="{{ old('hrsTrabajadas') }}">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" required
                                                                   class="datetimepicker_ form-control" name="hora01"
                                                                   id="hora01" value="{{ old('hora01') }}">
