                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" readonly class="form-control-plaintext"
                                                                   id="fechaInicio" value="{{ $orden->fechaInicio }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" readonly class="form-control-plaintext"
                                                                   id="fechaFinal" value="{{ $orden->fechaFinal }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        <label for="merma-yankee-dry" class="col-sm-6 col-form-label">Merma
                                                            Yankee Dry (kg):</label>
                                                        <div class="col-sm-6">
                                                            <h6 class="mt-2">{{ number_format($orden->mermaYankeeDry,2) }}
                                                                <span class="float-right">{{ $orden->porcentMermaYankeeDry }} %</span>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" readonly class="form-control-plaintext"
                                                                   id="produccionNeta" value="{{ $orden->horaInicio }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" readonly class="form-control-plaintext"
                                                                   id="horaFinal" value="{{ $orden->horaFinal }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        <label for="residuos-pulper" class="col-sm-6 col-form-label">Residuos
                                                            del Pulper (kg):</label>
                                                        <div class="col-sm-6">
                                                            <h6 class="mt-2">{{ number_format($orden->residuosPulper,2) }}
                                                                <span class="float-right">{{ $orden->porcentResiduosPulper }} %</span>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" readonly class="form-control-plaintext"
                                                                   id="produccionNeta"
                                                                   value="{{ number_format($orden->produccionNeta,2) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" readonly class="form-control-plaintext"
                                                                   id="produccionReal"
                                                                   value="{{ number_format($orden->produccionReal,2) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <h6 class="mt-2">{{ number_format($orden->lavadoraTetrapack,2) }}
                                                                <span class="float-right">{{ $orden->porcentLavadoraTetrapack }} %</span>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <!-- [ Tabla Mano de Obra Directa ] end -->
                            </div>
                            <div class="row">
                                ...
                                <!-- [ Tabla Costos Indirectos de Fabricacion ] start -->
                                <div class="col-xl-6 col-md-6">
                                    <div class="card card-event">
                                        <div class="card-header">
                                ...
                                <!-- [ Tabla Costos Indirectos de Fabricacion ] end -->
                            </div>
                            <div class="row">
                                    ...
                                    <div class="card card-social">
                                        ...
                                        <div class="card-block">
                                            <div class="row align-items-center justify-content-center card-active">
                                                <div class="col-3">
                                                    <h6 class="text-left m-b-10"><span
                                                            class="text-muted m-r-5">Inicial:</span>
                                                    </h6>
                                                </div>
                                                <div class="col-3">
                                                    <h6 class="text-right m-b-10"><span
                                                            class="text-muted m-r-5"></span>{{ number_format($orden->electricidad['inicial'],2) }}
                                                    </h6>
                                                </div>
                                                <div class="col-3">
                                                    <h6 class="text-left m-b-10"><span
                                                            class="text-muted m-r-5">Final:</span>
                                                    </h6>
                                                </div>
                                                <div class="col-3">
                                                    <h6 class="text-right m-b-10"><span
                                                            class="text-muted m-r-5"></span>{{ number_format($orden->electricidad['final'],2) }}
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card card-social">
                                        ...
                                        <div class="card-block">
                                            <div class="row align-items-center justify-content-center card-active">
                                                ...
                                                <div class="col-3">
                                                    <h6 class="text-right m-b-10"><span
                                                            class="text-muted m-r-5"></span>{{ number_format($orden->consumoAgua['inicial'],2) }}
                                                    </h6>
                                                </div>
                                                <div class="col-3">
                                                    <h6 class="text-left  m-b-10"><span
                                                ...
                                                <div class="col-3">
                                                    <h6 class="text-right  m-b-10"><span
                                                            class="text-muted m-r-5"></span>{{ number_format($orden->consumoAgua['final'],2) }}
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
