                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        <label for="merma-yankee-dry" class="col-sm-6 col-form-label">Merma
                                                            Yankee Dry:</label>
                                                        <div class="col-sm-6">
                                                            <h6 class="mt-2">{{ number_format($orden->mermaYankeeDry,2) }} <span
                                                                    class="float-right">{{ $orden->porcentMermaYankeeDry }} %</span>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        <label for="residuos-pulper" class="col-sm-6 col-form-label">Residuos
                                                            del Pulper:</label>
                                                        <div class="col-sm-6">
                                                            <h6 class="mt-2">{{ number_format($orden->residuosPulper,2) }} <span
                                                                    class="float-right">{{ $orden->porcentResiduosPulper }} %</span>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        <label for="lav-tetrapack" class="col-sm-6 col-form-label">Lavadora
                                                            de Tetrapack:</label>
                                                        <div class="col-sm-6">
                                                            <h6 class="mt-2">{{ number_format($orden->lavadoraTetrapack,2) }} <span
                                                                    class="float-right">{{ $orden->porcentLavadoraTetrapack }} %</span>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card card-social">
                                        <div class="card-block border-bottom">
                                            <div class="row align-items-center justify-content-center">
                                                ...
                                                <div class="col text-right">
                                                    <h3>{{ number_format($orden->consumoAgua['total'],2) }}</h3>
